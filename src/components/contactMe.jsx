...
const ContactMe = () => {
  return (
    <div className=" py-8 my-12" id="contact">
      <div className="flex bg-secondary items-center font-serif justify-center">
        <div className=" border-x-8 border border-black mr-2 md:w-[40rem] w-[25vh]" />
        <h1 className="text-black text-[1.5rem] text-center font-bold">
          Contact Me
        </h1>
        <div className=" border-x-8 border border-black ml-2 w-[25vh] md:w-[40rem]" />
      </div>
      <div className="flex flex-col bg-secondary items-center justify-center gap-[2rem] py-10">
        <div className="flex flex-col lg:flex-row gap-[2rem]">
          ...
          <h1 className="bg-secondary items-center justify-center flex p-2 rounded-xl text-[#b9a66c] font-bold hover:bg-[#212229]">
            <div className="flex gap-2">
        ...
        <div className="bg-secondary">
          <h1 className="bg-secondary p-2 rounded-xl text-[#b9a66c] font-bold hover:bg-[#212229]">
            <div className="flex gap-2">
      ...
      <div className="flex bg-secondary pb-4 items-center font-serif justify-center">
        ...
        <h1 className="text-white flex gap-3 text-[1.5rem] font-bold">
          ...
          <a href="https://wa.me/09753964884" rel="noreferrer" target="_blank">
            <FaWhatsapp />
          </a>
          <a
